      ...
      <div className="m-10 mx-auto grid max-w-screen-lg  gap-5 sm:grid-cols-3">
        ...
        >
          <svg
            ...
            className="bg-rose-400 h-14 w-14 rounded-xl p-4 text-white"
            viewBox="0 0 20 20"
            fill="currentColor"
          ...
          <p className="mt-2 pl-5 text-2xl font-bold text-black">{userCount}</p>
        ...
        >
          <svg
            fill="currentColor"
            className="h-14 w-14 rounded-xl p-4 text-white"
            version="1.1"
            id="Capa_1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="mt-4 text-xl font-extrabold text-black">Products</p>
          <p className="mt-2 pl-5 text-2xl font-bold text-black">
            {productCount}
          </p>
          <button className="mt-6 h-10 w-28  rounded-lg bg-black text-sm font-bold text-white shadow-lg hover:bg-gray-700">
            <Link to={"/dashboard/products"}>More info</Link>
          </button>
        </div>
